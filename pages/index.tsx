...
import { faSignInAlt, faUserPlus, faArrowCircleLeft } from "@fortawesome/free-solid-svg-icons";
...
function Index(props: IndexProps) {
  ...
  //           </Grid>
  //           <Grid item xs={12} sm={6}>
  //             <Button onClick={() => setShowLoginForm(false)} className={classes.button} variant="outlined" size="large" fullWidth color="primary" startIcon={<FontAwesomeIcon icon={faUserPlus} fixedWidth />}>
  //               Sign Up
  //             </Button>
  //           </Grid>
  //         </Grid>
  ...
  //     {/* Form Sub-Heading */}
  //     <Typography variant="body1" component="div" className={classes.subHeading}>
  //       Enter your details below to begin using Everest.
  //     </Typography>
  //     <Divider />
  ...
  //       <Grid container spacing={2} justify="center">
  //         <Grid item xs={12} sm={6}>
  //           <Button className={classes.button} variant="contained" size="large" fullWidth color="primary" startIcon={<FontAwesomeIcon icon={faUserPlus} fixedWidth />}>
  //             Sign Up
  //           </Button>
  //         </Grid>
  //         <Grid item xs={12} sm={6}>
  //           <Button onClick={() => setShowLoginForm(true)} className={classes.button} variant="outlined" size="large" fullWidth color="primary" startIcon={<FontAwesomeIcon icon={faArrowCircleLeft} fixedWidth />}>
  //             Back
  //           </Button>
  //         </Grid>
  //       </Grid>
  ...
  return (
    <>
      ...
      <Container maxWidth="sm" className={classes.container}>
        {/* {showLoginForm ? renderLoginForm() : renderSignUpForm()} */}
        {showLoginForm ? (
